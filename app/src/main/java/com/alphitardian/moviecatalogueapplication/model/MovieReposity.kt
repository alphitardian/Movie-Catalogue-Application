...
class MovieReposity private constructor(private val remoteDataSource: RemoteDataSource, private val apiConfig: ApiConfig) : MovieDataSource {

    companion object {
        @Volatile
        private var instance : MovieReposity? = null

        fun getInstance(remoteDataSource: RemoteDataSource, apiConfig: ApiConfig) : MovieReposity = instance ?: synchronized(this) {
            instance ?: MovieReposity(remoteDataSource, apiConfig).apply {
                instance = this
            }
        }
    }
